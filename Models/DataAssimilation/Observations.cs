...
namespace Models.DataAssimilation
{
    ...
    public class Observations : Model
    {
        ...
        public void Initialize_H()
        {
            ...
            H0Collect.Add(new ObsOperator("SW7", new string[] { "SW7" }, new double[] { 1 }));
            ...
            H0Collect.Add(new ObsOperator("SoilNO3_7", new string[] { "SoilNO3_7" }, new double[] { 1 }));
            ...
            H0Collect.Add(new ObsOperator("SoilNH4_7", new string[] { "SoilNH4_7" }, new double[] { 1 }));
            ...
            H0Collect.Add(new ObsOperator("SoilNTotal_7", new string[] { "SoilNH4_7", "SoilNO3_7" }, new double[] { 1, 1 }));
